...
from nnunet.experiment_planning.utils import analyze_dataset, crop, plan_and_preprocess, split_4d
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=8,
        help="number of processes used for " "preprocessing 2d and 3d_fullres " "data. Default: 3",
        required=False,
    )
    parser.add_argument(
        "-o",
        ...
        type=int,
        default=0,
        help="set this to 1 if you want to override " "cropped data and intensityproperties. Default: 0",
        required=False,
    )
    parser.add_argument(
        "-s",
