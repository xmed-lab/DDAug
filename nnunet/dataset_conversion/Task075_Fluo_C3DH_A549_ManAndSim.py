...
if __name__ == "__main__":
    source_folder_fluo_c3dh_a549 = (
        "/home/isensee/drives/E132-Rohdaten/CellTrackingChallenge/train/Fluo-C3DH-A549"
    )
    source_folder_fluo_c3dh_a549_sim = (
        "/home/isensee/drives/E132-Rohdaten/CellTrackingChallenge/train/Fluo-C3DH-A549-SIM"
    )
    source_folder_fluo_c3dh_a549_test = (
        "/home/isensee/drives/E132-Rohdaten/CellTrackingChallenge/test/Fluo-C3DH-A549"
    )
    source_folder_fluo_c3dh_a549_sim_test = (
        "/home/isensee/drives/E132-Rohdaten/CellTrackingChallenge/test/Fluo-C3DH-A549-SIM"
    )
    ...
    splits.append(
        {
            "train": [
                i[:-7]
                for i in cases
                if i.startswith("Fluo-C3DH-A549__01") or i.startswith("Fluo-C3DH-A549-SIM")
            ],
    ...
    splits.append(
        {
            "train": [
                i[:-7]
                for i in cases
                if i.startswith("Fluo-C3DH-A549__02") or i.startswith("Fluo-C3DH-A549-SIM")
            ],
    ...
    splits.append(
        {
            "train": [
                i[:-7]
                for i in cases
                if i.startswith("Fluo-C3DH-A549__") or i.startswith("Fluo-C3DH-A549-SIM__01")
            ],
    ...
    splits.append(
        {
            "train": [
                i[:-7]
                for i in cases
                if i.startswith("Fluo-C3DH-A549__") or i.startswith("Fluo-C3DH-A549-SIM__02")
            ],
