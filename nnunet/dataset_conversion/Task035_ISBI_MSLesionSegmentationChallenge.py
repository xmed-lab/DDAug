...
if __name__ == "__main__":
    ...
    json_dict["numTest"] = (
        len(subfiles("/media/fabian/My Book/MedicalDecathlon/Task035_ISBILesionSegmentation/imagesTs")) // 4
    )
    json_dict["training"] = [
        {"image": "./imagesTr/%s.nii.gz" % i[:-7], "label": "./labelsTr/%s.nii.gz" % i[:-7]} for i in tr_files
    ]
