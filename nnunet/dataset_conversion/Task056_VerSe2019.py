...
if __name__ == "__main__":
    ...
    test_files_base = [
        i[: -len(".nii.gz")] for i in subfiles(join(base, "test"), join=False, suffix=".nii.gz")
    ]
    ...
    train_patient_names = [
        i[: -len("_seg.nii.gz")] for i in subfiles(join(base, "train"), join=False, suffix="_seg.nii.gz")
    ]
