...
from nnunet.training.network_training.network_trainer import NetworkTrainer, NetworkTrainer_MCTS
from nnunet.training.network_training.nnUNetTrainer import nnUNetTrainer
from nnunet.training.network_training.nnUNetTrainer_MCTS import nnUNetTrainer_MCTS
...
def main():
    ...
    if network == "3d_cascade_fullres":
        ...
        assert issubclass(
            trainer_class, (nnUNetTrainer, nnUNetTrainer_MCTS, NetworkTrainer, NetworkTrainer_MCTS)
    ...
    if find_lr:
        ...
        if network == "3d_lowres" and not args.disable_next_stage_pred:
            ...
            predict_next_stage(
                trainer, join(dataset_directory, trainer.plans["data_identifier"] + "_stage%d" % 1)
            )
