...
class ExperimentPlanner3D_v22(ExperimentPlanner3D_v21):
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = join(self.preprocessed_output_folder, "nnUNetPlansv2.2_plans_3D.pkl")
    ...
    def get_target_spacing(self):
        ...
        if has_aniso_spacing and has_aniso_voxels:
            ...
            target_spacing_of_that_axis = max(
                max(other_spacings) * self.anisotropy_threshold, target_spacing_of_that_axis
            )
