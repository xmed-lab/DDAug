...
class ExperimentPlanner3D_residual_v21_bfnnUNet(ExperimentPlanner3D_v21):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = join(
            self.preprocessed_output_folder, "nnUNetPlans_bfnnUNet_fabresnet_plans_3D.pkl"
        )
...
class ExperimentPlanner3D_residual_v21_bfnnUNet_31(ExperimentPlanner3D_residual_v21_bfnnUNet):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = join(
            self.preprocessed_output_folder, "nnUNetPlans_bfnnUNet_fabresnet_31_plans_3D.pkl"
        )
...
class ExperimentPlanner3D_residual_v21_bfnnUNet_31_spRegnnU(ExperimentPlanner3D_residual_v21_bfnnUNet_31):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = join(
            self.preprocessed_output_folder, "nnUNetPlans_bfnnUNet_fabresnet_31_spnnU_plans_3D.pkl"
        )
        self.preprocessor_name = "Preprocessor3DBetterResampling"
