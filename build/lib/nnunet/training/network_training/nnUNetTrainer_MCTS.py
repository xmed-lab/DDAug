...
from nnunet.training.network_training.network_trainer import NetworkTrainer_MCTS
...
class nnUNetTrainer_MCTS(NetworkTrainer_MCTS):
    def __init__(
        self,
        plans_file,
        fold,
    ...
    def finish_online_evaluation(self):
        ...
        self.avg_foreground_dice = [np.round(i, 4) for i in global_dc_per_class]
        self.print_to_log_file("Average global foreground Dice:", self.avg_foreground_dice)
        self.print_to_log_file(
