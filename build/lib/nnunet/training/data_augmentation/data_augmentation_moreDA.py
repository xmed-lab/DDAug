...
def get_moreDA_augmentation(
    ...
    if params.get("selected_data_channels") is not None:
        ic(params.get("selected_data_channels"))
        tr_transforms.append(DataChannelSelectionTransform(params.get("selected_data_channels")))

    if params.get("selected_seg_channels") is not None:
        ic(params.get("selected_seg_channels"))
    ...
    # from .new_augments import OpticalDistortion, GridDistortion, ElasticTransform, Affine
    # GridDistortion.patch_size = patch_size
    # ElasticTransform.patch_size = patch_size
    # GridDistortion.patch_size = patch_size
    # Affine.patch_size = patch_size

    # print('added extra augs in moreDA')
    # tr_transforms.extend([OpticalDistortion(), ElasticTransform(), GridDistortion(), Affine((0.5, 1.5))])
    ...
    # tr_transforms = [RenameTransform("seg", "target", True), NumpyToTensor(["data", "target"], "float")]
