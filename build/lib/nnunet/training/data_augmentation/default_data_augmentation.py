...
default_2D_augmentation_params["rotation_y"] = (-0.0 / 360 * 2.0 * np.pi, 0.0 / 360 * 2.0 * np.pi)
default_2D_augmentation_params["rotation_z"] = (-0.0 / 360 * 2.0 * np.pi, 0.0 / 360 * 2.0 * np.pi)
...
if __name__ == "__main__":
    ...
    dl = DataLoader3D(
        dataset, basic_patch_size, np.array(plans["stage_properties"][0].patch_size).astype(int), 1
    )
