...
class ASPP(nn.Module):
    def __init__(
        ...
        self.transition = ConvBnAct3d(
            cat_channels, channels, kernel_size=1, padding=0, norm_type=norm_type, act_type=act_type
        )
