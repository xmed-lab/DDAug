...
class NestVBNet_CSE(NestVBNet):
    def __init__(self, in_channels, out_channels, **kwargs):
        super(NestVBNet_CSE, self).__init__(
...
class NestVBNet_SSE(NestVBNet):
    def __init__(self, in_channels, out_channels, **kwargs):
        super(NestVBNet_SSE, self).__init__(
...
class NestVBNet_SCSE(NestVBNet):
    def __init__(self, in_channels, out_channels, **kwargs):
        super(NestVBNet_SCSE, self).__init__(
...
class SK_NestVNet_ASPP(NestVNet_Base):
    def __init__(self, in_channels, out_channels, **kwargs):
        ...
        super(SK_NestVNet_ASPP, self).__init__(
            in_channels, out_channels, block_name="sk", use_aspp=True, **kwargs
        )
