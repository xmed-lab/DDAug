...
def preprocess_save_to_queue(
    preprocess_fn, q, list_of_lists, output_files, segs_from_prev_stage, classes, transpose_forward
):
    # suppress output
...
def preprocess_multithreaded(
    ...
    # assert isinstance(trainer, (nnUNetTrainer, nnUNetTrainer_MCTS))
    q = Queue(1)
    processes = []
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--all_in_gpu", type=str, default="None", required=False, help="can be None, False or True"
    )
