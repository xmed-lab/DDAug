...
final_pp_for_organs = [
    {"organ_id": "1", "dice": 0.9732512370778962, "json_name": "1_final_pipeline_rate0.10.json"},
    {"organ_id": "2", "dice": 0.9640832988865068, "json_name": "raw_metric.json"},
    {"organ_id": "3", "dice": 0.9560604701741481, "json_name": "raw_metric.json"},
    {"organ_id": "4", "dice": 0.8638663299956998, "json_name": "1_final_pipeline_rate0.50.json"},
    {"organ_id": "5", "dice": 0.8279895992855236, "json_name": "1_final_pipeline_rate0.90.json"},
    {"organ_id": "6", "dice": 0.9796343460008006, "json_name": "3_final_pipeline.json"},
    {"organ_id": "7", "dice": 0.9116198810299261, "json_name": "1_final_pipeline_rate0.25.json"},
    {"organ_id": "8", "dice": 0.954956293026744, "json_name": "2_final_pipeline_rate0.90.json"},
    {"organ_id": "9", "dice": 0.9127333677543994, "json_name": "1_final_pipeline_rate0.10.json"},
    {"organ_id": "10", "dice": 0.8666062113506989, "json_name": "raw_metric.json"},
    {"organ_id": "11", "dice": 0.7700240487854779, "json_name": "raw_metric.json"},
    {"organ_id": "12", "dice": 0.7800730312682457, "json_name": "raw_metric.json"},
    {"organ_id": "13", "dice": 0.8194899060127955, "json_name": "1_final_pipeline_rate0.10.json"},
    {"organ_id": "14", "dice": 0.9079541143746485, "json_name": "1_final_pipeline_rate0.50.json"},
    {"organ_id": "15", "dice": 0.8712155869104051, "json_name": "1_final_pipeline_rate0.25.json"},
]
...
def kidney_adrenal_left_right_confusion(predicted_label_map: np.ndarray, organ_ids: list[int]):
    ...
    for organ_label in [kidney_labels, adrenal_labels]:
        bin_organ_map = (predicted_label_map == organ_label["right"]) | (
            predicted_label_map == organ_label["left"]
        )
...
if __name__ == "__main__":
    ...
    for m in models:
        ...
        predict_cases_amos2022(
            join(parameter_folder, m),
            [[i] for i in input_files_fullpath],
            output_files,
            folds,
            save_npz=True,
    ...
    merge(
        [join(output_folder, m) for m in models],
        output_folder,
        num_threads_ensembling,
        override=overwrite_existing_ensembling,
    ...
    print(
        f"inference time {end_inference - start}, "
